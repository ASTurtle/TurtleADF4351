...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, ADF_CE_Pin|ADF_LE_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ADF_PDRF_GPIO_Port, ADF_PDRF_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ADF_CE_Pin ADF_LE_Pin ADF_PDRF_Pin */
  GPIO_InitStruct.Pin = ADF_CE_Pin|ADF_LE_Pin|ADF_PDRF_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
